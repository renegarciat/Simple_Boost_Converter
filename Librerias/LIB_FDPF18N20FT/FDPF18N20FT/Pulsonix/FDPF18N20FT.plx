...
(library Library_1
	...
	(patternDef "TO254P490X1016X1970-3P" (originalName "TO254P490X1016X1970-3P")
		...
		(layerContents (layerNumRef 28)
			(line (pt 7.72 3.26) (pt 7.72 -1.64) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 7.72 -1.64) (pt -2.64 -1.64) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt -2.64 -1.64) (pt -2.64 3.26) (width 0.025))
		)
		(layerContents (layerNumRef 28)
	...
	(compDef "FDPF18N20FT" (originalName "FDPF18N20FT") (compHeader (numPins 3) (numParts 1) (refDesPrefix Q)
		...
		(attr "<Hyperlink>" "https://www.onsemi.com/download/data-sheet/pdf/fdpf18n20ft-d.pdf")
		(attr "<Component Height>" "4.9")
		(attr "<STEP Filename>" "FDPF18N20FT.stp")
